...
$(document).ready(function(){
  ...
  var $result = $("#result");
	...
	$next.click(function(){
        ...
        $result.html("You are not there yet!  <br>  <br> You like your personal comfort and enjoy avoiding taking heads. It is okay, but you can improve your lifestyle step by step tohelp reversing climate breakdown.  <br>  <br> It is possible if we all do something and it starts by you ! Please check out the Lifestyle page to check out what you can change in your daily life, sone step at the time.");
}else{
