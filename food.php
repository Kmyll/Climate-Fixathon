...
<div class="container" id="top">
  ...
  <p>  Food play a big weight in our carbon footprint. According to The World Bank and IFC’s report Livestock and Climate Change, 50% of the man-produced carbon footprint comes from meat, dairy and egg farming. Besides, housing, transport, and food transformation add up several CO2 emissions as well. And if this was not enough, the world is now facing water shortage in some part of the world, that, if not regulated, can cause several damages.<br><br>

    To avoid that, we can already individually pay attention to these different components of our food supply:
  </p>
  ...
  <ul>
    ...
    <li>Meat is very controverted since it needs water. According to foodtank, to produce one beef (approx. 540 kg or 1200 pounds) 2 158 800 gallons of water are necessary (over 8 171 946 liters).
      ...
      <li>Finally, do it for your health : animals are fed to gain mass in a minimum of time. This is not natural, and they are often fed with hormones to enhance this growth alongside with antibiotics to protect them from possible bacteria. By eating this food, you are ingesting growth hormone as well as these antibiotics, which can make you antibiotic-resistant and lead to important health problems.</li>
        </div>
    </ul>
    <br>
    ...
    <ul>
      ...
      <ul>
          <div data-aos="fade-right">
        <h3><i class="fas fa-egg"></i> Eggs</h3><br>
        <li>This one is less obvious but, according to the SINC (Spanish "Servicio de Información y Noticias Científicas"), 68 million tons of eggs are produced worldwide. This lead to chicken farms who are close to each other, don't have enough space to move and live between feces, dead other chickens and bacteria, which "generates negative effects on the environment, including the emission of greenhouse gases or the contamination of soil and water."</li><br>
        <li>However, it is okay to eat either organic or free-range eggs, from chickens who can roam freely outdoors, which enhance the quality of the eggs while restricting the footprint.</li>
              </div>
      </ul>
...
<h2>Buy quality food</h2>
      ...
      <ul>
        ...
        <li>Shopping locally allows you to save local employments as well as CO2 expense, because the food and good you purchase are seasonal, made locally in your neighborhood and did not flew from the other side of the world (like strawberries in the middle of winter).</li> <br>
        <li>If you buy food that is from the other side of the world, try to buy fair trade productions, more respectful of the farmers and the environment, rather than huge farming factories.</li>
            </div>
      </ul>
<br>
      <ul>
          <div data-aos="fade-right">
        <h3><i class="fas fa-carrot"></i> Try to buy organic food as much as possible</h3>
        <li>First, for your health: Pesticides are not natural and has been proven by the farmers who died of cancer that it may be carcirogenic, so so it is better to avoid non organic food, as a precaution (fruits, vegetables, meat, fish...). <a href="img/food/dirty-dozen.png"target="_blank">Here</a> you can see the famous "clean 10 and dirty dozen" good highly (or not) treated.</li><br>
        <li>Secondly, for the environment: According to the US National Library of Medicine,  "Pesticides can contaminate soil, water, turf, and other vegetation. In addition to killing insects or weeds, pesticides can be toxic to a host of other organisms including birds, fish, beneficial insects, and non-target plants."</li>
            </div>
      </ul>
<br>
      <ul>
        ...
        <li>Instead, eat a lot of grains, legumes, and vegetable, it will benefit your health as well as the environment.</li>
            </div>
      </ul>
      ...
      <ul>
        ...
        <li>Moreover, since the world is facing more and more heatwaves, episodes of dryness are going to emphasis this shortage, which will eventually lead to food and financial insecurities, conflicts and immigrations</li><br>
        <li>Finally, if nothing is done, the United Nations Organization predicts the global water deficit will be around 40% by 2030. It is therefore important to use water consciously to keep the entire world thirst and hunger satiated.</li>
              </div>
      </ul><br>
