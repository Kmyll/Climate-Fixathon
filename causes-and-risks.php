...
<h2><i class="fas fa-thermometer-three-quarters"></i> Effects in numbers</h2>

<p>Some people think climate breakdown is a myth, that it is not really happening. However, according to the <a href="https://climate.nasa.gov/" target="_blank">NASA</a> :</p> <br>

  <ul class="second-dropdown">
  <li>The carbon dyoxide increased by 412 parts per milion (the highest ever recorded)</li>
  <li>The global temperature increased by 1.9 degrees F since 1880 (and the warmest years are occuring since 2001)</li>
  <li>The artic ice is decreasing by 12.8% per decades (with its minimum since 2012)</li>
  <li>Ice sheets are decreasing by 413 gigatonnes per year</li>
  <li>Sea levels are yearly increasing by 3.3mm (17.8cm over the past century)</li>
</ul>
...
<p>Now that we know all the causes and the consequences on our land and our health, we <b>must</b> take action to reverse climate change. </p>
